...
class ConverterViewModel(
    ...
    private val _state = MutableStateFlow(ConverterModelState.default(accountRepository.balance))
...
//                marketInteractor.currencies()
    ...
    private fun ConverterAction.SubmitCurrencyAction.submit() {
        launchOn {
            ...
            accountRepository.balance = mapOf(sell.name to sell.balance, receive.name to result)
